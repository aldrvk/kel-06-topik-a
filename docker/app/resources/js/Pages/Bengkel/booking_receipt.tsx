...
export default function BookingReceipt() {
    ...
    useEffect(() => {
        ...
        if (raw) {
            ...
            if (!data.confirmed) {
                router.visit('/bengkel/booking-detail');
                return;
            }
            setBooking(data);
        } else {
    ...
    const handleReturnHome = () => {
        localStorage.removeItem('bengkel_booking');
        router.visit('/bengkel');
    };
    ...
    return (
        <div className="min-h-screen bg-background flex flex-col">
            <Head title="Booking Dikonfirmasi – bengkel" />
            <Navbar />
                ...
                <div className="bg-card border border-border rounded-venus overflow-hidden shadow-xl shadow-border/30">
                    ...
                    <div className="px-6 py-5 border-b border-border flex flex-col sm:flex-row items-start sm:items-center gap-5 bg-surface/50">
                        ...
                        <div>
                            ...
                            <p className="text-h4 text-super-black">Venus Hub – bengkel</p>
